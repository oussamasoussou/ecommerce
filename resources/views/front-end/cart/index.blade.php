                ...
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        ...
                        <div class="breadcrumb">
                            <a href="{{ route('shop.index') }}" rel="nofollow"><i class="fi-rs-home mr-5"></i>Accueil</a>
                            <span></span> Panier
                        </div>
                    </div>
                            ...
                            <tr class="cart-item-{{ $item->id }}">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('shop.show', $item->produit_id) }}" class="me-3" style="width: 80px;">
                                ...
                                <td class="text-center align-middle">
                                    <button class="btn btn-link text-danger btn-remove" 
                                            data-cart-id="{{ $item->id }}"
                                            title="Supprimer">
