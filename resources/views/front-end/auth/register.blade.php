                    ...
                    <div class="col-xl-8 col-lg-10 col-md-12 m-auto">
                        <div class="row">
                            ...
                            <div class="col-lg-6 pr-30 d-none d-lg-block">
                                <img class="border-radius-15" src="{{ asset('front-end/imgs/page/register.jpg') }}"
                                    alt="Connexion" />
                            </div>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            ...
                                            <p class="mb-30">Vous avez déjà un compte ? <a
                                                    href="{{ route('frontend.login') }}"
                                                    class="text-brand">Connectez-vous</a></p>
                                        </div>
                                        ...
                                        {{-- Le bloc principal d'erreurs a été supprimé pour afficher les erreurs champ par
                                        champ --}}
                                        ...
                                        <form method="POST" action="{{ route('frontend.register.post') }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" name="city" placeholder="Ville (Optionnel)"
                                                            value="{{ old('city') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" name="country" placeholder="Pays (Optionnel)"
                                                            value="{{ old('country') }}"
                                            ...
                                            <div class="login_footer form-group mb-30">
                                                <div class="chek-form">
                                                    <div class="custome-checkbox">
                                                        ...
                                                        <label class="form-check-label" for="terms"><span>J'accepte les
                                                                **termes & conditions** <a href="#">En savoir
                                                                    plus</a></span></label>
                                                    </div>
                                                </div>
                                                @error('terms')
                                            ...
                                            <p class="font-xs text-muted">**Note:** Vos données personnelles sont utilisées
