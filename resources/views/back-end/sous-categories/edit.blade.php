...
@section('title', 'Modifier la Sous-Catégorie - Admin')

@section('content')
<section class="content-main">
    <div class="content-header d-flex justify-content-between align-items-center mb-4">
        <h2 class="content-title mb-0">Modifier la sous-catégorie</h2>
        <a href="{{ route('souscategories.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-light py-3">
            <h5 class="card-title mb-0">Modifier les informations de la sous-catégorie</h5>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <label class="form-label fw-semibold">Nom de la sous-catégorie <span class="text-danger">*</span></label>
                                <input type="text" name="name" 
                                       value="{{ old('name', $sousCategorie->name) }}" 
                                       class="form-control @error('name') is-invalid @enderror" 
                                       placeholder="Ex: Smartphones, Vêtements Homme..." required>
                                @error('name')
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea name="description" rows="5" 
                                          ...
                                          placeholder="Décrivez cette sous-catégorie...">{{ old('description', $sousCategorie->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="sticky-top" style="top: 20px;">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <!-- Logo actuel -->
                                    @if($sousCategorie->logo)
                                        <div class="text-center mb-3">
                                            <img src="{{ asset('storage/' . $sousCategorie->logo) }}" 
                                                 alt="Logo actuel" 
                                    ...
                                    <div class="text-center mb-3">
                                        ...
                                        <div id="logoPlaceholder" class="border-2 border-dashed border-gray-300 rounded-lg p-4" 
                                             style="{{ $sousCategorie->logo ? 'display: none;' : '' }}">
                            ...
                            <div class="card">
                                <div class="card-header bg-light py-2">
                                    <h6 class="mb-0">Image de la sous-catégorie</h6>
                                </div>
                                <div class="card-body">
                                    <!-- Image actuelle -->
                                    @if($sousCategorie->image)
                                        <div class="text-center mb-3">
                                            <img src="{{ asset('storage/' . $sousCategorie->image) }}" 
                                                 alt="Image actuelle" 
                                                 class="img-fluid border rounded p-2 bg-white" 
                                    ...
                                    <div class="text-center mb-3">
                                        ...
                                        <div id="imagePlaceholder" class="border-2 border-dashed border-gray-300 rounded-lg p-4" 
                                             style="{{ $sousCategorie->image ? 'display: none;' : '' }}">
