...
@section('title', 'Nouvelle Sous-Catégorie - Admin')

@section('content')
<section class="content-main">
    <div class="content-header d-flex justify-content-between align-items-center mb-4">
        <h2 class="content-title mb-0">Nouvelle Sous-Catégorie</h2>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-light py-3">
            <h5 class="card-title mb-0">Informations de la sous-catégorie</h5>
        </div>
        <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <input type="text" name="name" 
                                       ...
                                       placeholder="Ex: Smartphones, Vêtements Homme, Meubles Salon..." required>
                                @error('name')
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea name="description" rows="5" 
                                          ...
                                          placeholder="Décrivez cette sous-catégorie...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="bi bi-plus-circle"></i> Créer la sous-catégorie
                            </button>
                        </div>
                    </div>
                </div>
