...
<section class="content-main">
    <div class="content-header d-flex justify-content-between align-items-center mb-4">
        <h2 class="content-title mb-0">Créer une nouvelle couleur</h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('couleurs.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- Nom -->
